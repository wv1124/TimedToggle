...
public class DimenTool {
    ...
    public static void gen() {
        ...
        try {
            ...
            String tempString;
            int line = 1;
            // one time read one line until read null;

            while ((tempString = reader.readLine()) != null) {

                if (tempString.contains("</dimen>") && !tempString.contains("fab_elevation")) {
                    ...
                    sw768.append(start).append((int) Math.round(num * 0.96)).append(end).append("\n");
